        ...
        <section className="home-page">
            ...
            <div className="personnalisation-menu">
                ...
                <div className="img-personnalisation-menu">
                    <img src={imgPersonnalisationMenu1} className='img1' alt="Image homme tenant un menu" />
                    <img src={imgPersonnalisationMenu2} alt="Image montrant la façade d'un restaurant" />
                </div>
            </div>
        </section>
    )
